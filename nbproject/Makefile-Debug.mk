...
${OBJECTDIR}/src/IORegistersMemoryRule.o: src/IORegistersMemoryRule.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/IORegistersMemoryRule.o src/IORegistersMemoryRule.cpp
...
${OBJECTDIR}/src/Cartridge.o: src/Cartridge.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Cartridge.o src/Cartridge.cpp

${OBJECTDIR}/src/opcodes.o: src/opcodes.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/opcodes.o src/opcodes.cpp

${OBJECTDIR}/src/MemoryCell.o: src/MemoryCell.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/MemoryCell.o src/MemoryCell.cpp
...
${OBJECTDIR}/src/Audio.o: src/Audio.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Audio.o src/Audio.cpp

${OBJECTDIR}/src/opcodes_cb.o: src/opcodes_cb.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/opcodes_cb.o src/opcodes_cb.cpp

${OBJECTDIR}/src/Video.o: src/Video.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Video.o src/Video.cpp

${OBJECTDIR}/src/RomOnlyMemoryRule.o: src/RomOnlyMemoryRule.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/RomOnlyMemoryRule.o src/RomOnlyMemoryRule.cpp

${OBJECTDIR}/src/MBC1MemoryRule.o: src/MBC1MemoryRule.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/MBC1MemoryRule.o src/MBC1MemoryRule.cpp

${OBJECTDIR}/src/Processor.o: src/Processor.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Processor.o src/Processor.cpp

${OBJECTDIR}/src/GearboyCore.o: src/GearboyCore.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/GearboyCore.o src/GearboyCore.cpp

${OBJECTDIR}/src/MBC5MemoryRule.o: src/MBC5MemoryRule.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/MBC5MemoryRule.o src/MBC5MemoryRule.cpp

${OBJECTDIR}/src/SixteenBitRegister.o: src/SixteenBitRegister.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/SixteenBitRegister.o src/SixteenBitRegister.cpp
