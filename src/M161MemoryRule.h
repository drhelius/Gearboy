...
#ifndef M161MEMORYRULE_H
#define M161MEMORYRULE_H

#include "MemoryRule.h"

class M161MemoryRule : public MemoryRule
{
public:
    M161MemoryRule(Processor* pProcessor, Memory* pMemory,
            Video* pVideo, Input* pInput, Cartridge* pCartridge, Audio* pAudio);
    virtual ~M161MemoryRule();
