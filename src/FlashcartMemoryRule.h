...
#ifndef FLASHCARTMEMORYRULE_H
#define FLASHCARTMEMORYRULE_H

#include "MemoryRule.h"

class FlashcartMemoryRule : public MemoryRule
{
public:
    FlashcartMemoryRule(Processor* pProcessor, Memory* pMemory,
            Video* pVideo, Input* pInput, Cartridge* pCartridge, Audio* pAudio);
    virtual ~FlashcartMemoryRule();
