...
#ifndef HUC1MEMORYRULE_H
#define	HUC1MEMORYRULE_H

#include "MemoryRule.h"

class HuC1MemoryRule : public MemoryRule
{
public:
    HuC1MemoryRule(Processor* pProcessor, Memory* pMemory,
            Video* pVideo, Input* pInput, Cartridge* pCartridge, Audio* pAudio);
    virtual ~HuC1MemoryRule();
