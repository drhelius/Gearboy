...
static void set_defaults(void)
{
    ...
    config_input.key_a = SDL_SCANCODE_S;
    config_input.key_b = SDL_SCANCODE_A;
    config_input.key_start = SDL_SCANCODE_RETURN;
    config_input.key_select = SDL_SCANCODE_SPACE;
    config_input.gamepad = true;
    config_input.gamepad_invert_x_axis = false;
    config_input.gamepad_invert_y_axis = false;
    config_input.gamepad_a = SDL_GAMEPAD_BUTTON_EAST;
    config_input.gamepad_b = SDL_GAMEPAD_BUTTON_SOUTH;
    config_input.gamepad_start = SDL_GAMEPAD_BUTTON_START;
    config_input.gamepad_select = SDL_GAMEPAD_BUTTON_BACK;
    ...
    {
        config_input_gamepad_shortcuts.gamepad_shortcuts[j] = SDL_GAMEPAD_BUTTON_INVALID;
    }
...
void config_read(void)
{
    ...
    config_input.key_a = (SDL_Scancode)read_int("Input", "KeyA", SDL_SCANCODE_S);
    config_input.key_b = (SDL_Scancode)read_int("Input", "KeyB", SDL_SCANCODE_A);
    ...
    config_input.gamepad_a = read_int("Input", "GamepadA", SDL_GAMEPAD_BUTTON_EAST);
    config_input.gamepad_b = read_int("Input", "GamepadB", SDL_GAMEPAD_BUTTON_SOUTH);
    config_input.gamepad_start = read_int("Input", "GamepadStart", SDL_GAMEPAD_BUTTON_START);
    config_input.gamepad_select = read_int("Input", "GamepadSelect", SDL_GAMEPAD_BUTTON_BACK);
