; Game Boy dot matrix preset adapted from libretro slang-shaders handheld/gameboy.

[Preset]
Name=Game Boy Dot Matrix
Passes=5
SourcePalette=BlackWhite

[Pass0]
Path=gameboy_dot_matrix_pass0.glsl
ScaleType=Viewport
Filter=Nearest
History=true
...
[Pass4]
Path=gameboy_dot_matrix_pass4.glsl
ScaleType=Previous
Filter=Nearest
